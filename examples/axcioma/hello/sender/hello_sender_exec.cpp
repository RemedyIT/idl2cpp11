...
//@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl[user_global_impl]

namespace CIAO_Hello_Sender_Impl
{
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl[user_namespace_impl]
  void
  foo_generator::set_context(
    IDL::traits<Hello::CCM_Sender_Context>::ref_type context)
  {
    this->context_ = IDL::traits<Hello::CCM_Sender_Context>::narrow (context);
  }
  ...
  //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl[user_namespace_impl]
  ...
  Sender_exec_i::~Sender_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[dtor]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[configuration_complete]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[configuration_complete]
  }

  void Sender_exec_i::ccm_activate ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_activate]
    ...
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_activate]
  }

  void Sender_exec_i::ccm_passivate ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_passivate]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_passivate]
  }

  void Sender_exec_i::ccm_remove ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_remove]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[ccm_remove]
  }
    ...
    IDL::traits<Components::SessionContext>::ref_type ctx)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl::Sender_exec_i[set_session_context]
    this->context_ = IDL::traits<Hello::CCM_Sender_Context>::narrow (ctx);
    //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl::Sender_exec_i[set_session_context]
  }


  //@@{__RIDL_REGEN_MARKER__} - BEGIN : CIAO_Hello_Sender_Impl[user_namespace_end_impl]
  //@@{__RIDL_REGEN_MARKER__} - END : CIAO_Hello_Sender_Impl[user_namespace_end_impl]
